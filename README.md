# 2026: Prompt to Pixel 완전 정복

> AI 이미지 생성의 프롬프트 설계부터 실전 포트폴리오까지 — **12챕터 61섹션** 튜토리얼
...
> Part 1에서 프롬프트 구조를 마스터한 뒤, Part 2에서 ChatGPT·Gemini·Midjourney 각 플랫폼을 실전 활용하고, Part 3에서 편집·제어 기법을 익힌 후, Part 4에서 일관성 유지와 포트폴리오 프로젝트를 완성합니다.
